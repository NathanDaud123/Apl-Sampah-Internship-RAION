...
class SubPickUpKertas : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_sub_pick_up_kertas)

        val estimasi_kertas = findViewById<TextView>(R.id.angka_estimasi)

        val lanjut = findViewById<ImageView>(R.id.rec_lanjut)
        val kertas = findViewById<TextView>(R.id.text_plastik)
        ...
        plus1.setOnClickListener{
            ...
            estimasi_kertas.setText(Integer.toString(total_kertas))
        }
        ...
        lanjut.setOnClickListener{
            ...
            intent.putExtra("estimasiPlastik", estimasi_kertas.text.toString())
//            intent.putExtra("jenisPlastik", kertas.text.toString())
